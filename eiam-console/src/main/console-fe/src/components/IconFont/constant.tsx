...
export const ICON_LIST = {
  ...
  // MFA  因子
  mfa_factor_sms: <IconFont name="icon-sms" />,
  mfa_factor_mail: <IconFont name="icon-mail" />,
  mfa_factor_otp: <IconFont name="icon-otp" />,
  mfa_factor_fingerprint: <IconFont name="icon-fingerprint" />,
  mfa_factor_face: <IconFont name="icon-face" />,
