...
@Component
public class OidcStandardCertificateApplicationServiceImpl extends
                                                           AbstractOidcCertificateApplicationService {
    private final Logger logger = LoggerFactory
        .getLogger(OidcStandardCertificateApplicationServiceImpl.class);
    ...
    protected OidcStandardCertificateApplicationServiceImpl(AppCertRepository appCertRepository,
