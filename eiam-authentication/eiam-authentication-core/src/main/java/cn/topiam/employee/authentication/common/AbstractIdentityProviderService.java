 ...
 */
public abstract class AbstractIdentityProviderService implements IdentityProviderService {
    private final Logger logger = LoggerFactory.getLogger(AbstractIdentityProviderService.class);
}
