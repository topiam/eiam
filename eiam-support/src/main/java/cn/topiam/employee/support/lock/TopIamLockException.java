...
/**
 * TopIam Lock Exception
 *
 * @author TopIAM
 * Created by support@topiam.cn on 2020/9/16 22:51
 */
public class TopIamLockException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected TopIamLockException(String message, Throwable cause, boolean enableSuppression,
