...
import static cn.topiam.employee.support.error.TopIamErrorAttributes.*;

/**
 * 默认异常页面
 *
 * @author TopIAM
 * Created by support@topiam.cn on  2022/4/30 22:37
 */
public class TopIamErrorStaticView implements View {

    private static final MediaType TEXT_HTML_UTF8 = new MediaType("text", "html",
        StandardCharsets.UTF_8);

    private static final Log       logger         = LogFactory.getLog(TopIamErrorStaticView.class);
