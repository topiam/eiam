 ...
 */
public enum SamlSignAssertAlgorithmType {
    ...
    SamlSignAssertAlgorithmType(String value) {
        this.value = value;
    }
    ...
    @EnumConvert
    public static SamlSignAssertAlgorithmType getType(String code) {
        SamlSignAssertAlgorithmType[] values = values();
        for (SamlSignAssertAlgorithmType status : values) {
